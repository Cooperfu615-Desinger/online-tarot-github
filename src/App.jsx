...
function App() {
    ...
    const generatePrompt = () => {
        ...
        prompt += `\n請務必嚴格遵守以下輸出格式（不要省略任何部分，也不要加額外的標題標籤）：\n\n(第一行直接給出一句結合歷史典故或生活哲理的幽默金句，不要加【金句】這種標籤)\n\n\n智者的建議：\n1. (建議一)\n2. (建議二)\n3. (建議三)\n\n語氣設定：\n你要像一位風趣的歷史老師，用「講故事」或「打比方」的方式給建議。例如：「就像諸葛亮也得借東風，你現在缺的不是實力，是時機。」\n禁止事項：\n1. 禁止使用「老夫」、「乖孫」等年長者用語。\n2. 禁止使用 Markdown 粗體符號 (**)。\n3. 金句不要太抽象，要白話且有梗。\n字數控制：200 字以內。請使用繁體中文。`;
        return prompt;
    };
