...
const GOOGLE_API_KEY = "AIzaSyARDT3PDljPi5lzIdrvaoK32DF0ZusG0aA"; // Updated API Key
...
function App() {
    ...
    const generatePrompt = () => {
        ...
        prompt += `\n請你採用『李誕』那種慵懶、自嘲、看透人生的黑色幽默風格，但務必轉化為『台灣道地的口語』來解讀。\n\n語氣設定：\n要像個有點厭世的台灣朋友在居酒屋跟你碎念，直白、好笑但又很中肯。\n\n重要禁令：\n千萬不要使用中國大陸的用語（如：沒誰了、鐵汁、給力、視頻），請改用台灣鄉民或年輕人的慣用語（如：也是醉了、有夠扯、傻眼、母湯、是在哈囉）。\n\n格式要求：\n1. 絕對禁止使用 Markdown 的粗體符號（即不要出現 ** ）。\n2. 總字數控制在 300 字以內。\n3. 最後請用條列式給出 3 個「厭世又實用」的行動建議。\n4. 請用繁體中文（台灣習慣用法）回答。`;
        return prompt;
    };
